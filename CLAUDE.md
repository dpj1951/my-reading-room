...
- Platform: Render (Starter $7/mo Ã¢ÂÂ always-on, no sleep) Flask + Gunicorn
...
- `dnf` Ã¢ÂÂ Did Not Finish shelf (below Want to Read, dimmed/grayscale)
- Default is `read` if no status set

---

## Supabase Schema (books table Ã¢ÂÂ 14 columns)
...
- pages stored as varchar string Ã¢ÂÂ parse with int()
...
- Render Starter ($7/mo): always-on, 512MB RAM, 0.5 CPU Ã¢ÂÂ good for early growth
...
- CSV import does synchronous Google Books/Open Library lookups Ã¢ÂÂ future: use ThreadPoolExecutor
- **Render pricing update coming August 1, 2026 Ã¢ÂÂ review before that date**

---

## PWA Icons & Branding (updated May 6, 2026)

- static/icons/icon-192.png Ã¢ÂÂ PWA app icon 192ÃÂ192 (blue alcove illustration on cream background)
- static/icons/icon-512.png Ã¢ÂÂ PWA app icon 512ÃÂ512 (same illustration, higher res)
- static/icons/alcove_logo.png Ã¢ÂÂ standalone logo for home page footer (300ÃÂ400 portrait)
...
- Source image: alcove_logo_copy.jpeg (portrait ~686ÃÂ1024)
...
- Found clean content bounds: rows 288â907, cols 275â685; trimmed stray bottom line artifacts
- Generated icon-192.png (192Ã192) and icon-512.png (512Ã512) centered on cream background
...
- Generated correct square crops using Pillow Ã¢ÂÂ crop starts at ~22% from top to show the sitting reader prominently
- icon-192.png: 192ÃÂ192px square crop of alcove illustration
- icon-512.png: 512ÃÂ512px square crop of same illustration
...
- User uploaded alcove_logo.jpeg Ã¢ÂÂ blue line-art reading alcove illustration (portrait orientation)
- Generated PWA icons (192ÃÂ192 and 512ÃÂ512) from the illustration using canvas
- Generated alcove_logo.png (300ÃÂ400) for home page footer logo
...
## What Was Done May 4, 2026 Ã¢ÂÂ Session 2 (Responsive Footer Logo)
- Created 3 responsive logo sizes: alcove_logo_sm.png (147ÃÂ220), alcove_logo_md.png (206ÃÂ307), alcove_logo_lg.png (270ÃÂ402)
...
- Author shelf feature Ã¢ÂÂ full publication shelf per author with Google Books API (client-side)
...
- Half-star ratings (0.5Ã¢ÂÂ5.0)
...
- If old page serves after deploy: Render Shell Ã¢ÂÂ kill -9 $(pgrep -f gunicorn) Ã¢ÂÂ Render restarts automatically
...
- Note: extension blocks SHA/base64 values returned from JS Ã¢ÂÂ use split workarounds to retrieve SHAs
...
- Consider: stamp date_added on want_to_read Ã¢ÂÂ reading transition